...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        title: new Text("Flutter Quotes App",style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
        actions: <Widget>[
          new IconButton(icon: new Icon(Icons.search), onPressed: (){
            showSearch(context: context, delegate: Search(QuotesList: QuotesData));
          }),
          new IconButton(icon: new Icon(Icons.next_plan), onPressed: (){
            fetchQuoteData();
          }),
        ],
      ),
        ...
        child: new Column(
          children: <Widget>[
            new UserAccountsDrawerHeader(
              ...
              accountEmail: new Text("lavum27p@gmail.com",style: TextStyle(fontSize: 15,color: Colors.white),),
      ...
      body: QuotesData == null ? new Center(
        child: new CircularProgressIndicator(),
          ...
          new Column(
            children: <Widget>[
              if(QuotesData[index]["author"]!=null || QuotesData[index]["author"]!='null'|| QuotesData[index]["author"]!='Null' || QuotesData[index]["author"]!=Null)...[
                new Card(
                    ...
                    child: new ListTile(
                        ...
                        subtitle: new Text( "-"+QuotesData[index]["author"].toString(),style: TextStyle(fontSize: 15,color: Colors.grey[700],fontWeight: FontWeight.bold),)
                    )
                ),
                ...
                new Card(
                    ...
                    child: new ListTile(
                        title: new Text(QuotesData[index]["text"],style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                        subtitle: new Text("-null",style: TextStyle(fontSize: 15,color: Colors.grey[700],fontWeight: FontWeight.bold),)
                    )
                ),
                new Padding(padding: const EdgeInsets.only(bottom: 5)),
              ]
