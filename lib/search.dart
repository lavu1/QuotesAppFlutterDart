...
class Search extends SearchDelegate{
  ...
  Search({required this.QuotesList});
          ...
          children: <Widget>[
            new Card(
                ...
                child: new ListTile(
                  ...
                  subtitle: new Text("-"+suggestionList[index]["author"].toString(),style: TextStyle(fontSize: 15,color: Colors.grey[700],fontWeight: FontWeight.bold),),
                )
            ),
